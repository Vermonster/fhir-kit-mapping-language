...
const basicStructureDefinition = require('../fixtures/basic-structure-definition.json');

test('typesByDefinitionAndPath', () => {
  const type = typesByDefinitionAndPath(basicStructureDefinition,
    'created');
